...
**YOU ARE IN: `mario_ftw/polecats/furiosa/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/mario_ftw/` (rig root) or other directories
...
**Your mail address:** `mario_ftw/polecats/furiosa`
**Your rig:** mario_ftw
**Your Witness:** `mario_ftw/witness`
...
| Ask Witness for help | `gt mail send mario_ftw/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`mario_ftw/witness`) when:
...
```bash
gt mail send mario_ftw/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
